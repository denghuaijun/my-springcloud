...
import com.dhj.springcloud.fallback.DeptFeginServiceFallBackFactory;
 ...
 * 然后在生产提供者也引入此依赖
 */
@FeignClient(value = "SPRINGCLOUD-PROVIDER",fallbackFactory = DeptFeginServiceFallBackFactory.class)
public interface DeptFeginService {
    ...
    @RequestMapping(value = "/hystrix/queryDeptById/{id}",method = RequestMethod.GET)
